  ...
  <div class="services-container">
    ...
    <table>
      ...
      <tbody>
        <tr v-for="service in services" :key="service._id">
          ...
          <td>
            <button class="edit-button" @click="editService(service)"> Edit
              <i class="fas fa-edit"></i>
            </button>
            <button class="delete-button" @click="deleteService(service)"> Delete
    ...
    <div class="form-container">
      ...
      <form v-if="showForm">
        ...
        <button class="create-button" @click.prevent="createService">Create</button>
        <button class="cancel-button" @click.prevent="showForm = false">Cancel</button>
      </form>
      <div class="modal" v-if="editServiceData">
        <div class="modal-content">
          ...
          <button class="cancel-button" @click="editServiceData = null">Cancel</button>
        </div>
      </div>
    </div>
  </div>
